...
//	 		 Address s1 = new Address("Anusha", "nallapu", " Rotary nagar",
//	 		 "96528xxx", "507303",
//	 		 "khammam", "tamilnadu");

//	 		 s1.display();

			AddressbookUC3 b = new AddressbookUC3 ();
			b.AddPreson();
		        b.AddPreson();
			b.EditPerson("Anusha", "chinni");
			//b.DeletePerson("Anu");
	...
	public void EditPerson(String string, String string2) {
		// TODO Auto-generated method stub
